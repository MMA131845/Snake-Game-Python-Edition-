...
# ========== 游戏版本：v2.1.0 - 大世界·摄像机跟随 ==========
VERSION = "v2.1.0"
CHANGELOG = f"""版本 {VERSION} - 大世界·摄像机跟随

✨ 新增功能：
- 摄像机跟随蛇头，始终居中显示
- 地图扩大至 3000x2000，更广阔战场
- 鼠标移动控制方向（世界坐标映射）
- 敌人AI主动觅食
- 敌人持续生成，最多10个
- 敌人死亡掉落密集红色大食物
...
# ========== 游戏配置 ==========
WIDTH, HEIGHT = 1600, 900               # 屏幕窗口尺寸（16:9）
WORLD_WIDTH, WORLD_HEIGHT = 3000, 2000  # 世界地图尺寸（16:9）
