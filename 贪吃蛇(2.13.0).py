...
# ========== 游戏版本：v2.13.0 - 开始界面退出按钮 ==========
VERSION = "v2.13.0"
CHANGELOG = f"""版本 {VERSION} - 开始界面退出按钮
...
def draw():
    ...
    if settings_mode:
        ...
        if int(time.time() * 2) % 2 == 0:
            writer.goto(0, 50)
            writer.write("按 SPACE 开始游戏", align="center", font=("Microsoft YaHei", 24, "bold"))

        # 设置选项
        writer.goto(0, 0)
        writer.write("按 S 进入设置", align="center", font=("Microsoft YaHei", 18, "normal"))

        # 重新开始选项
        writer.goto(0, -50)
        writer.write("按 R 重新开始", align="center", font=("Microsoft YaHei", 18, "normal"))

        # 退出选项
        writer.goto(0, -100)
        writer.write("按 Q 退出游戏", align="center", font=("Microsoft YaHei", 18, "normal"))
