...
def draw():
    ...
    if settings_mode:
        ...
        # 绘制返回按钮
        back_rect = pygame.Rect(BACK_BUTTON_POS[0], BACK_BUTTON_POS[1], BACK_BUTTON_WIDTH, BACK_BUTTON_HEIGHT)
        if back_button_hover:
            ...
            pygame.draw.rect(screen, START_BG, back_rect)
