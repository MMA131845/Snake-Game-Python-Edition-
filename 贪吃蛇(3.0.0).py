...
def draw():
    ...
    if settings_mode:
        ...
        if not game_active:
            game_over = font_info.render("GAME OVER  按 R 重新开始", True, WHITE)
...
# ========== 初始化游戏 ==========
def new_game():
    global snake, direction, foods, score, game_active, boosting, color_centers, enemies, pending_enemy_spawns, spawn_timer_active, kills
    snake = [(0, 0), (-16, 0), (-32, 0), (-48, 0), (-64, 0)]
    direction = (1, 0)
    score = 0
    kills = 0
